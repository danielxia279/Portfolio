...
function Contactbar(props){
    ...
    return(
        <div className={css(styles.contactbar)}
            onMouseEnter={() => setShowLabels(true)}
            onMouseLeave={() => setShowLabels(false)}
        >
            <div className={css(styles.buttonContainer, styles.github)}> 
                <a className={css(styles.svg)} href="https://github.com/Dancharr?tab=repositories" target="_blank">
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 128 128'>
                        <g className="icon" fill='white'>
            ...
            <div className={css(styles.buttonContainer, styles.linkedin)}> 
                <a className={css(styles.svg)} href="https://www.linkedin.com/in/daniel-xia-094581171/" target="_blank">
                    <svg id='Linkedin' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 128 128'>
